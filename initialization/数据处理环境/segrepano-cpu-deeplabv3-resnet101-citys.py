...
# # 删除缓存的模型文件
# model_cache_dir = os.path.expanduser('~/.mxnet/models')
# model_files = ['deeplab_resnet101_citys-*.params', 'deeplab_resnet101_citys-*.json']
# for model_file in model_files:
#     for file in glob.glob(os.path.join(model_cache_dir, model_file)):
#         os.remove(file)
#         print(f"Deleted cached model file: {file}")
