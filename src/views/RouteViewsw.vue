...
import { parseUrlParams, toggleRouteList, getColor, highlightRoute, onTimeInputChange, isDateDisabled, handleDateChange, onSearchInputChange, selectResult } from '@/assets/share_js/routeview_public'
